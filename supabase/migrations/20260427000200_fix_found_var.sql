-- Bug fix: the original upsert_note used PL/pgSQL's implicit FOUND variable
-- after an intervening INSERT, which clobbered it. Capture the SELECT result
-- explicitly so the update-vs-insert branch is deterministic.
